...
For this type of ELISA, quantification of the antibody titers is performed using serial dilutions of the test samples where the titer is reported as the highest sample dilutions that produces a signal reliably above the background. 
