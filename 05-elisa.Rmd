...
```{r}
elisa_serial_dilution_data <- read_excel("DATA/elisa_data_serial_dilution.xlsx"
                               )
# pivot longer the data

elisa_serial_dilution_data_tidy <- pivot_longer(data = elisa_label_data, cols = "...1":"...12", names_to = "well_id", values_to = "information")

head(elisa_serial_dilution_data)
```
