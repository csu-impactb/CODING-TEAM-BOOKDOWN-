...
elisa_fitted_data <- fitted_model_elisa(elisa_data_nested$data[[1]], start_a = 4, start_d = 0, start_c = -8, start_b = 1) 
...
# Run the endpoint titer function
endpoint_titer_elisa(elisa_fitted_data, back_value = 0.2)
```
