...
\hypersetup{
  pdftitle={Connect R to Microsoft Teams},
  pdfauthor={Taru Dutt},
  hidelinks,
...
\begin{center}\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-34-1} \end{center}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-42-1.pdf}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-55-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my\_team }\OtherTok{\textless{}{-}} \FunctionTok{get\_team}\NormalTok{(}\StringTok{"CVMBS T\_cell\_mask\_study"}\NormalTok{, }
             \AttributeTok{app =} \StringTok{"04b07795{-}8ddb{-}461a{-}bbee{-}02f9e1bf7b46"}\NormalTok{)}

\NormalTok{my\_team}\SpecialCharTok{$}\FunctionTok{list\_channels}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
