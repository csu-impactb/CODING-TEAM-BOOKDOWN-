...
\hypertarget{an-example-of-elisa-data}{%
\subsection{An example of ELISA data}\label{an-example-of-elisa-data}}
...
\subsubsection{An example of the fitting sigmoid model is below:}\label{an-example-of-the-fitting-sigmoid-model-is-below}}
...
\paragraph{Clean the data}\label{clean-the-data}}
...
\paragraph{Create a fitted sigmoid model function and apply the function to the data}\label{create-a-fitted-sigmoid-model-function-and-apply-the-function-to-the-data}}
...
\hypertarget{plot-the-signmoid-curve-with-fitted-sigmoid-model}{%
\paragraph{Plot the signmoid curve with fitted sigmoid model}\label{plot-the-signmoid-curve-with-fitted-sigmoid-model}}
...
\subsubsection{Create an endpoint titer function and apply it to the output of the fitted sigmoid model values.}\label{create-an-endpoint-titer-function-and-apply-it-to-the-output-of-the-fitted-sigmoid-model-values.}}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{elisa\_data\_with\_endpoint\_titer}\SpecialCharTok{$}\NormalTok{endpoint\_data}\OtherTok{=}\FunctionTok{as.numeric}\NormalTok{(elisa\_data\_with\_endpoint\_titer}\SpecialCharTok{$}\NormalTok{endpoint\_data)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{elisa\_data\_stats }\OtherTok{\textless{}{-}} \FunctionTok{t.test}\NormalTok{(endpoint\_data }\SpecialCharTok{\textasciitilde{}}\NormalTok{ Groups, }\AttributeTok{data =}\NormalTok{ elisa\_data\_with\_endpoint\_titer)}
...
## 1  -0.800   -14.0   -13.2   -18.8 2.68e-6    5.63  -0.906  -0.695 Welch~ two.si~
