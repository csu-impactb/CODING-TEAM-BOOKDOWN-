...
template \href{https://github.com/csu-impactb/CODING-TEAM-BOOKDOWN-/raw/main/DATA/body_weights_template.xlsx}{here}. The worksheet is divided into sheets. The first sheet is
...
\includegraphics[width=52.51in]{figures/weight_template_initial}
...
\includegraphics[width=58.24in]{figures/weight_template_page}
...
This section provides the details of that pipeline. It aims to explain the
...
function (\texttt{read\_mouse\_weights}) creates a list of all of the sheets in the
...
\CommentTok{\# Use function to read in mouse weights from the sheet}
\CommentTok{\# (we\textquotesingle{}ll read in the initial information later)}
\NormalTok{our\_mouse\_weights }\OtherTok{\textless{}{-}} \FunctionTok{read\_mouse\_weights}\NormalTok{(}\AttributeTok{filepath =} \StringTok{"DATA/body\_weights\_measurement.xlsx"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Add a unique mouse ID. For right now, add it only for the first time point.}
...
\CommentTok{\# mouse, over the course of all data collected to date}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-9-1.pdf}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-9-2.pdf}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-9-3.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{write\_csv}\NormalTok{(our\_mouse\_weights, }\StringTok{"DATA/example\_mouse\_output.csv"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-27-1} \end{center}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-35-1.pdf}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-48-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{my\_team }\OtherTok{\textless{}{-}} \FunctionTok{get\_team}\NormalTok{(}\StringTok{"CVMBS{-}MIP IMPAc{-}TB"}\NormalTok{, }\AttributeTok{app =} \StringTok{"04b07795{-}8ddb{-}461a{-}bbee{-}02f9e1bf7b46"}\NormalTok{)}

\CommentTok{\# get the channel}

\NormalTok{channels }\OtherTok{\textless{}{-}}\NormalTok{ my\_team}\SpecialCharTok{$}\FunctionTok{get\_channel}\NormalTok{()}

\CommentTok{\# get the folder}

\NormalTok{folder }\OtherTok{\textless{}{-}}\NormalTok{ channels}\SpecialCharTok{$}\FunctionTok{get\_folder}\NormalTok{()}

\CommentTok{\# list files}
\NormalTok{files }\OtherTok{\textless{}{-}}\NormalTok{ folder}\SpecialCharTok{$}\FunctionTok{list\_files}\NormalTok{()}

\CommentTok{\# open weight file}

\NormalTok{body\_weight }\OtherTok{\textless{}{-}}\NormalTok{ folder}\SpecialCharTok{$}\FunctionTok{get\_item}\NormalTok{(}\StringTok{"Mouse\_labeling\_and\_weighing/Body Weights.xlsx"}\NormalTok{)}
\NormalTok{body\_weight}\SpecialCharTok{$}\FunctionTok{open}\NormalTok{()}
\NormalTok{body\_weight}\SpecialCharTok{$}\FunctionTok{download}\NormalTok{(}\AttributeTok{overwrite=}\ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
