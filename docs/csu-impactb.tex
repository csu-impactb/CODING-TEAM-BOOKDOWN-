...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Add a unique mouse ID, starting with just the first time point}
\NormalTok{ex }\OtherTok{\textless{}{-}}\NormalTok{ ex }\SpecialCharTok{\%\textgreater{}\%} 
...
\NormalTok{mice\_cage\_lists }\OtherTok{\textless{}{-}}\NormalTok{ ex }\SpecialCharTok{\%\textgreater{}\%} 
  ...
  \FunctionTok{mutate}\NormalTok{(}\AttributeTok{cage\_list =} \FunctionTok{map2}\NormalTok{(}\AttributeTok{.x =}\NormalTok{ existing\_cage\_number, }
                          ...
                          \AttributeTok{.f =} \SpecialCharTok{\textasciitilde{}} \FunctionTok{get\_mouse\_cages}\NormalTok{(.x, .y, }\AttributeTok{df =}\NormalTok{ ex)))}

\CommentTok{\# Add a column with the latest cage to the weight dataframe}
\NormalTok{ex}\SpecialCharTok{$}\NormalTok{latest\_cage }\OtherTok{\textless{}{-}} \ConstantTok{NA}
...
\NormalTok{  ex}\SpecialCharTok{$}\NormalTok{mouse\_id[ex}\SpecialCharTok{$}\NormalTok{notch\_id }\SpecialCharTok{==}\NormalTok{ this\_notch\_id }\SpecialCharTok{\&} 
\NormalTok{                       ex}\SpecialCharTok{$}\NormalTok{existing\_cage\_number }\SpecialCharTok{\%in\%} 
\NormalTok{                       this\_cage\_list] }\OtherTok{\textless{}{-}}\NormalTok{ this\_unique\_id}
  
\NormalTok{  ex}\SpecialCharTok{$}\NormalTok{latest\_cage[ex}\SpecialCharTok{$}\NormalTok{notch\_id }\SpecialCharTok{==}\NormalTok{ this\_notch\_id }\SpecialCharTok{\&} 
\NormalTok{                       ex}\SpecialCharTok{$}\NormalTok{existing\_cage\_number }\SpecialCharTok{\%in\%} 
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-7-1.pdf}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-7-2.pdf}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-7-3.pdf}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-12-1.pdf}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-19-1.pdf}
...
\begin{center}\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-25-1} \end{center}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-46-1.pdf}
