...
\NormalTok{elisa\_example\_data }\OtherTok{\textless{}{-}} \FunctionTok{separate}\NormalTok{(elisa\_example\_data, }
                               ...
                               \AttributeTok{into =} \FunctionTok{c}\NormalTok{(}\StringTok{"numerator"}\NormalTok{, }\StringTok{"denomenator"}\NormalTok{), }
...
\NormalTok{  elisa\_example\_data}\SpecialCharTok{$}\NormalTok{numerator}\SpecialCharTok{/}\NormalTok{elisa\_example\_data}\SpecialCharTok{$}\NormalTok{denomenator  }
...
\subsubsection{Plot the signmoid curve with fitted sigmoid model}\label{plot-the-signmoid-curve-with-fitted-sigmoid-model}}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-23-1.pdf}
...
\begin{center}\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-29-1} \end{center}
...
\includegraphics{csu-impactb_files/figure-latex/unnamed-chunk-37-1.pdf}
