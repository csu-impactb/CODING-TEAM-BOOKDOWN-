...
# Multiday Plot
joined_df$group <- factor(joined_df$group, levels = c("Saline", "BCG", "BCG BCG", "IN Inulin", "IM CPG"))

ggplot(joined_df, aes(x = group, y = percentage_of_LIVE, fill = group)) +
  geom_boxplot(aes(x = group, y = percentage_of_LIVE),
 ...
 theme_bw() + 
  theme(axis.text.x = element_text(size = 50, angle = 45, hjust = 1),
        ...
        plot.title = element_text(color="black", size=60, face="bold")) +
  labs(x = "Vaccine", y = "Percentage of Live Leukocytes", color = "Group")+
  guides(shape = "none") +
  theme(strip.text = element_text(size=45, face = "bold")) + 
  theme(legend.position="right") +
  ggtitle("SolaVax TB Comprehensive Panel BAL Day 30") +
  facet_wrap(~reorder(cell_types, -percentage_of_LIVE), 
