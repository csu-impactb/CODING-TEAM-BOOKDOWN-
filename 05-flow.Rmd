...
# leveneTest to test for variances
...
anova_result <- aov(percentage_of_LIVE ~ group, data = tidy_Df1)

# Check the assumption of equal variances using Levene's test
levene_test <- leveneTest(anova_result, center = mean)
summary(levene_test)
...
data(tidy_Df1, package = "afex")

o1 <- aov_ez("group", "percentage_of_LIVE", obk.long, 
             between = c("group", "percentage_of_LIVE"))



https://cran.r-project.org/web/packages/afex/vignettes/assumptions_of_ANOVAs.html

https://statsandr.com/blog/kruskal-wallis-test-nonparametric-version-anova/#assumptions
```
